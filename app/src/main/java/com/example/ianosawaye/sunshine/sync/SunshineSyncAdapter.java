...
import com.example.ianosawaye.sunshine.MainActivity;
import com.example.ianosawaye.sunshine.R;
import com.example.ianosawaye.sunshine.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        Log.v(LOG_TAG,"In onPerformSync");
    ...
    private void notifyWeather() {
        ...
        boolean showNotifications = prefs.getBoolean(context.getString(R.string.pref_notification_key), getContext().getResources().getBoolean(R.bool.pref_notification_default));
