...
/**
 * Created by ianosawaye on 14-10-20.
 */
public class WeatherContract {


    public static final String CONTENT_AUTHORITY = "com.example.ianosawaye.sunshine.app";
    ...
    public static final class LocationEntry implements BaseColumns {
        ...
        // Column with the  key into the location table.
        public static final String COLUMN_LOCATION_SETTING = "location_setting";

        public static final String COLUMN_CITY_NAME = "city_name";

        //latitude is stored as a float
        public static final String COLUMN_COORD_LAT = "coord_lat";

        // longitude is stored as a float
